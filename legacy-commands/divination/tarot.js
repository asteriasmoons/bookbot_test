...
module.exports = {
    ...
    try { //try till try to do this
        let Starchild = require('../../scripts/tarot/starchild.json'); //the tarot script

        let SetDeck = [ Starchild]; // sets the deck
        ...
        .setTitle(`**<:t2:954427242732200026> | ${CardOutcome.number} |  ${CardOutcome.name} | <:t2:954427242732200026>**`)
        ...
        if (args[0] === '3' && !args[1]) { // if command is -tarot 3 and has no other argument  it will send 3 cards
            ...
            .setTitle(`**<:t2:954427242732200026> ${SetCardOutcome.name} <:t2:954427242732200026>**`)
            ...
            .setTitle(`**<:t2:954427242732200026> ${SetCardOutcomeThree.name} <:t2:954427242732200026>**`)
