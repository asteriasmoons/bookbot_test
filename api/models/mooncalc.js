...
(function () {
    ...
    function getMoonInformations(date) {
      ...
      if (age <  1.84566) {
        ...
        emoji = '<:nmoon:907829038360432691>';
        ...
        emoji = '<:first:907829403143270431>';
        trajectory = 'ascendent';
        ...
        emoji = '<:fmoon:907829690318852177>';
        ...
        emoji = '<:third:907829961900044311>';
        trajectory = 'descendent';
